...
function initFooter() {
    ...
    footerLogo.addEventListener("mouseenter", () => {
      ...
      if (logoImage) {
        ...
        logoImage.style.filter =
          "brightness(1.2) drop-shadow(0 0 10px rgba(0, 255, 102, 0.6))";
      }

      if (logoText) {
        logoText.style.textShadow = "0 0 15px rgba(0, 255, 102, 0.6)";
      }
    });
  ...
  if (versionBadge) {
    versionBadge.addEventListener("mouseenter", () => {
      versionBadge.style.transform = "scale(1.05) translateY(-2px)";
      versionBadge.style.boxShadow = "0 6px 20px rgba(0, 255, 102, 0.4)";
    });
