...
const Contacto = () => {
  ...
  // Cargar el CSS y JS de Contacto cuando se monte el componente
  useEffect(() => {
    // Cargar CSS
    const link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = "/css/contacto.css";
    document.head.appendChild(link);

    // Cargar JavaScript
    const script = document.createElement("script");
    script.src = "/javaScript/contacto.js";
    script.async = true;
  ...
  const offices = [
    {
      ...
      email: "santacruz@PRIMERO DE JUNIO.edu.bo",
    ...
    },
    {
      ...
      email: "mexico@PRIMERO DE JUNIO.edu.bo",
    ...
    },
    {
      ...
      city: "Bogotá D.C.",
      phone: "+57 1 234-5678",
      email: "bogota@PRIMERO DE JUNIO.edu.bo",
      hours: "Lun - Vie: 8:00 - 18:00",
      isHeadquarters: false,
    ...
    },
    {
      ...
      email: "madrid@PRIMERO DE JUNIO.edu.bo",
  ...
  const experienceLevels = [
    ...
    "Intermedio (1-3 años)",
    "Avanzado (3+ años)",
    "Profesional (desarrollador institucional)",
  ];
            ...
            <div className="contact-preview">
              <div className="preview-header">
                ...
                <div className="preview-info">
                  <div className="preview-name">Asesor PRIMERO DE JUNIO</div>
