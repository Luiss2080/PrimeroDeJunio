...
const Conductores = () => {
  ...
  const courses = [
    ...
    {
      id: 2,
      title: "Conductor Experimentado Pro",
      description:
        "Estrategias profesionales para conductores experimentados. Técnicas institucionales y algoritmos avanzados.",
      price: 499,
      originalPrice: 699,
      image: "🚀",
      level: "avanzado",
    ...
    },
    {
      ...
      description:
        "Mentoría personalizada 1:1 con conductores institucionales. Acceso exclusivo a señales premium.",
      price: 1999,
      originalPrice: 2999,
      image: "👑",
      level: "vip",
  ...
  return (
    <div className="Conductores-page">
      {/* Hero Section */}
      <section className="Conductores-hero">
