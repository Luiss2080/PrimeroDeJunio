...
const Asociaci�n = () => {
  ...
  return (
    <div className="Asociaci�n-page">
      {/* Hero Section */}
      <section className="Asociaci�n-hero">
        <div className="container">
          <div className="hero-content">
            <div className="hero-badge">
              <span className="badge-icon">🎓</span>
              <span>Asociaci�n #1 en Latinoamérica</span>
            </div>
      ...
      {/* Tabs Navigation */}
      <section className="Asociaci�n-tabs">
        <div className="container">
      ...
      {/* Tab Content */}
      <section className="Asociaci�n-content">
        <div className="container">
      ...
      {/* CTA Section */}
      <section className="Asociaci�n-cta">
        <div className="container">
