...
-- Logs de creacion de datos iniciales
(1, 'CREATE', 'conductores', 1, NULL, '{"nombre": "Juan Manuel", "apellido": "Perez Garcia", "cedula": "12345678"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', DATE_SUB(NOW(), INTERVAL 15 DAY)),
(1, 'CREATE', 'conductores', 2, NULL, '{"nombre": "Maria Elena", "apellido": "Gonzalez Lopez", "cedula": "87654321"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', DATE_SUB(NOW(), INTERVAL 15 DAY)),
...
-- Logs de asignaciones de vehiculos
...
-- Logs de creacion y gestion de viajes
...
-- Logs de configuracion del sistema
...
-- Logs de gestion de clientes
(2, 'CREATE', 'clientes', 1, NULL, '{"nombre": "Andrea", "apellido": "Gomez", "telefono": "3201234567", "tipo_cliente": "frecuente"}', '192.168.1.100', 'Mozilla/5.0 (Linux; Android 10; SM-G975F) AppleWebKit/537.36', DATE_SUB(NOW(), INTERVAL 8 DAY)),
...
(1, 'UPDATE', 'pagos_tarifa_diaria', 3, '{"estado": "pendiente"}', '{"estado": "exonerado", "observaciones": "Exonerado por mantenimiento de vehiculo"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', NOW()),
...
-- Logs de actualizacion de conductores
(1, 'UPDATE', 'conductores', 1, '{"telefono": "3012345678"}', '{"telefono": "3012345679", "direccion": "Nueva direccion actualizada"}', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', DATE_SUB(NOW(), INTERVAL 2 DAY)),
...
-- Logs de actualizacion de vehiculos
...
-- Logs de eliminacion/cancelacion
(1, 'DELETE', 'viajes', 15, '{"estado": "pendiente", "motivo": "Cliente no se presento"}', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', DATE_SUB(NOW(), INTERVAL 2 HOUR)),
(2, 'UPDATE', 'mantenimientos', 8, '{"estado": "programado"}', '{"estado": "cancelado", "motivo_cancelacion": "Cliente cancelo cita"}', '192.168.1.100', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', DATE_SUB(NOW(), INTERVAL 6 HOUR));
