...
[![Tecnologías](https://img.shields.io/badge/Stack-React%20%2B%20PHP%20%2B%20MySQL-blue?style=for-the-badge)]()
[![Entrega](https://img.shields.io/badge/Entrega-30%20Días-green?style=for-the-badge)]()
[![Garantía](https://img.shields.io/badge/Garantía-12%20Meses-yellow?style=for-the-badge)]()
[![Soporte](https://img.shields.io/badge/Soporte-24%2F7-red?style=for-the-badge)]()
...
```mermaid
graph TD
    A[Usuario en Website] --> B{¿Quiere acceder al sistema?}
    B -->|Sí| C[Página de Login]
    B -->|No| D[Continúa navegando]
    C --> E[Ingresa credenciales]
    E --> F{¿Datos válidos?}
    F -->|No| G[Error + Intento nuevo]
    F -->|Sí| H[Verifica rol]
    H --> I{¿Qué tipo de usuario?}
    I -->|Admin| J[Dashboard Administrativo]
    I -->|Operador| K[Panel Operativo]
    I -->|Supervisor| L[Panel de Supervisión]
    I -->|Conductor| M[Portal del Conductor]
```
