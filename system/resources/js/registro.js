/**
 * NEXORIUM REGISTRATION - JAVASCRIPT OPTIMIZADO
 * Funciones específicas para el registro de usuarios
 */

class NexoriumRegistration {
    constructor() {
        this.form = null;
        this.inputs = {};
...
// ===== INICIALIZAR ===== //
const nexoriumRegistration = new NexoriumRegistration();

// Funciones globales para debugging (opcional)
window.nexoriumRegistration = nexoriumRegistration;
