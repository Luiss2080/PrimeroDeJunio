/**
 * NEXORIUM PASSWORD RECOVERY - JAVASCRIPT OPTIMIZADO
 * Funciones específicas para la recuperación de contraseña
 */

class NexoriumRecovery {
    constructor() {
        this.form = null;
        this.inputs = {};
...
// ===== INICIALIZAR ===== //
const nexoriumRecovery = new NexoriumRecovery();

// Funciones globales para debugging (opcional)
window.nexoriumRecovery = nexoriumRecovery;
