/**
 * PRIMERO DE JUNIO - ASOCIACIÓN MOTOTAXIS - LOGIN JAVASCRIPT
...
document.addEventListener("DOMContentLoaded", function () {
  console.log("🔐 PRIMERO DE JUNIO Login: Sistema iniciado");
...
function showInputSuccess(input) {
  input.style.borderColor = "rgba(0, 255, 102, 0.5)";
  input.style.boxShadow = "0 0 0 3px rgba(0, 255, 102, 0.1)";
}
...
function initializeSocialLinks() {
  ...
  socialLinks.forEach((link) => {
    link.addEventListener("click", function (e) {
      e.preventDefault();
      const platform = this.classList[1]; // servicios, conductores, asociacion, soporte
...
function handleSocialLink(platform) {
  ...
  switch (platform) {
    case "servicios":
      message =
        "🏍️ Conoce todos nuestros servicios de mototaxi con cobertura en toda la ciudad y tarifas preferenciales.";
      action = "Ver Servicios";
      break;
    case "conductores":
      message =
        "👥 Únete a nuestro equipo de conductores profesionales y obtén beneficios exclusivos de la asociación.";
      action = "Unirse como Conductor";
      break;
    case "asociacion":
      message =
        "🏢 Conoce más sobre PRIMERO DE JUNIO, nuestra historia, misión y los beneficios para nuestros afiliados.";
      action = "Conocer Asociación";
      break;
    case "soporte":
      message =
        "💬 Nuestro equipo de soporte está disponible 24/7 para resolver tus dudas y apoyarte en lo que necesites.";
      action = "Contactar Soporte";
      break;
    case "whatsapp":
      message =
        "💬 Contacta directamente con nuestro equipo vía WhatsApp para soporte inmediato y solicitar servicios.";
      action = "Contactar por WhatsApp";
      break;
    case "facebook":
      message =
        "📘 Síguenos en Facebook para noticias de la asociación, eventos y beneficios para conductores.";
      action = "Seguir en Facebook";
      break;
    case "instagram":
      message =
        "📷 Síguenos en Instagram para fotos de nuestros servicios, conductores y actividades de la asociación.";
      action = "Seguir en Instagram";
      break;
    case "youtube":
      message =
        "📺 Suscríbete a nuestro canal de YouTube para videos educativos, testimonios y noticias.";
      action = "Suscribirse a YouTube";
      break;
    default:
      return;
  }
  ...
  modal.innerHTML = `
    <div class="modal-content">
      <div class="modal-header">
        <h3>🏍️ PRIMERO DE JUNIO Asociación de Mototaxis</h3>
        <button class="modal-close">&times;</button>
      </div>
      <div class="modal-body">
        <p>${message}</p>
        <p><strong>Esta funcionalidad estará disponible próximamente.</strong></p>
        <p>Mientras tanto, utiliza las credenciales de demo para explorar la plataforma administrativa.</p>
...
function showContactModal() {
  ...
  modal.innerHTML = `
    <div class="modal-content">
      <div class="modal-header">
        <h3>🏍️ Registro de Conductor - PRIMERO DE JUNIO</h3>
        <button class="modal-close">&times;</button>
      </div>
      <div class="modal-body">
        <p><strong>¿Quieres unirte a nuestra asociación de mototaxis?</strong></p>
        <p>Solicita tu registro como conductor profesional en PRIMERO DE JUNIO y obtén beneficios exclusivos.</p>
        <div class="contact-options">
          <div class="contact-item">
            <strong>📧 Registro:</strong> registro@primero1dejunio.com
          </div>
          <div class="contact-item">
            <strong>💬 WhatsApp:</strong> +57 (300) 123-4567
          </div>
          <div class="contact-item">
            <strong>📞 Oficina:</strong> +57 (1) 234-5678
          </div>
          <div class="contact-item">
            <strong>🔐 Acceso Demo:</strong> admin@primero1dejunio.com / mototaxi123
          </div>
        </div>
      </div>
    </div>
...
// Función para debug
function debugLogin() {
  console.log("🔐 PRIMERO DE JUNIO Login Debug:", {
...
console.log("✅ PRIMERO DE JUNIO Login: JavaScript cargado correctamente");
