...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleDropdown(type) {
        const dropdown = type === 'notifications' ? notificationsDropdown : userDropdown;
    ...
    function addNotification(notification) {
        ...
        const notifications = notificationsList.querySelectorAll('.notification-item:not(.no-notifications)');
