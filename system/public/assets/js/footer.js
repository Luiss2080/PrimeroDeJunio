...
class FooterSystem {
    ...
    gsap.to(
      { value: 0 },
      {
        ...
        onUpdate: function () {
          ...
          valueElement.textContent = hasPrefix
            ? `$${formattedValue}`
            : formattedValue;
        },
      }
  ...
  animateFooterElements() {
    ...
    const sections = this.footer?.querySelectorAll(
      ".footer-brand, .footer-nav, .footer-contact, .footer-actions"
    );
  ...
  setCompactMode(isCompact) {
    ...
    if (isCompact) {
      ...
      const hideElements = this.footer?.querySelectorAll(
        ".footer-top, .footer-social, .footer-actions"
      );
      ...
      const showElements = this.footer?.querySelectorAll(
        ".footer-top, .footer-social, .footer-actions"
      );
