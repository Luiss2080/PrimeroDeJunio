...
<style>
/* Estilos específicos para editar vehículo */
.vehicle-edit-photo-modern {
    display: flex;
...
.current-photo-modern:hover .photo-overlay-modern {
    opacity: 1;
}
...
.documents-edit-modern {
    display: grid;
    gap: 1.5rem;
}

.document-edit-item-modern {
    padding: 1.5rem;
...
.timeline-marker-modern.success {
    background: var(--success-color);
}

.timeline-marker-modern.warning {
    background: var(--warning-color);
}

.timeline-marker-modern.danger {
...
/* Indicadores de estado de documentos */
.text-success {
