...
(1, '2025-11-17', 15000.00, 'efectivo', 1, 'Pago realizado en la mañana', 'pagado'),
...
(5, '2025-11-17', 0.00, 'efectivo', 1, 'Exonerado por mantenimiento de vehículo', 'exonerado');
...
(3, DATE_SUB('2025-11-17', INTERVAL 2 DAY), 15000.00, 'transferencia', 1, 'Transferencia del día anterior', 'pagado'),
(4, DATE_SUB('2025-11-17', INTERVAL 2 DAY), 0.00, 'efectivo', 1, 'Día de descanso autorizado', 'exonerado'),
